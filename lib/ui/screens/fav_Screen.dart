...
class fav_Screen extends StatefulWidget {
  final String title;
  const fav_Screen({Key key, this.title}) : super(key: key);
...
class CadburyState extends State<fav_Screen> {
  DatabaseHelper databaseHelper = DatabaseHelper();
  List<Note> noteList;
  int count = 0;

  deleteFromDatabase(item)async{
    //await databaseHelper.deleteNote(item);
    await databaseHelper.updateNote(item);
                                ...
                                Column(
                                  children: [
                                    IconButton(
                                      ...
                                      onPressed: () {
                                        setState(() {
                                          favList2.removeAt(idx);
                                          deleteFromDatabase(favList2[idx]);
                                        });
                                      },
                                    ),
                                    IconButton(
                                      ...
                                      color: Colors.black54,
                                      onPressed:()=> _launchURL(favList2[idx].ProductLink),
                                    ),
                                  ],
                                ),
                ...
                style: Theme.of(context)
                    ...
                    /*GridView.builder(
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            ...
                            return ProductContainer1(id: index);
                          },
                        )*/
...
class ProductContainer1 extends StatelessWidget {
  ...
  const ProductContainer1({Key key, this.id}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return GestureDetector(
                        ...
                        children: <Widget>[
                          ...
                          Align(
                            ...
                            child: RaisedButton(shape: RoundedRectangleBorder(
                              ...
                              onPressed: () =>_launchURL(favList2[widget.id].ProductLink),
